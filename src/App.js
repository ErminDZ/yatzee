...
function App() {
  ...
  return (
    <div className="App">
      <h1>YATZEEEE!! with the BOYSSSSS</h1>
...
Small and Large Straight: A straight is a sequence of consecutive die faces; a small straight is made up of die faces 1-2-3-4-5 and scores 15 points; a large straight is made up of die faces 2-3-4-5-6 and scores 20 points.
        ...
        Chance: Roll anything and put it into the Chance category, the score is the total of the die faces.</p>

        <p>Zero score: If you cannot score a category after your 3 rolls, choose any category and mark 0 points to it.</p>
